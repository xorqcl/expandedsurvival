...
public class AlloyRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> recipeItems;
    private final FluidStack fluidStack;

    public AlloyRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Serializer implements RecipeSerializer<AlloyRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(ExpandedSurvival.MODID, "alloying");
        ...
        public AlloyRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ...
            return new AlloyRecipe(pRecipeId, output, inputs, fluid);
        }

        @Override
        public @Nullable AlloyRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            NonNullList<Ingredient> inputs = NonNullList.withSize(2, Ingredient.EMPTY);
            ...
            return new AlloyRecipe(id, output, inputs, fluid);
        }
