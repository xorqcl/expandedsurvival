...
public class BiomeInit {
    public static final ResourceKey<Biome> SKYLAND = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(ExpandedSurvival.MODID, "skyland"));

    public static void boostrap(BootstapContext<Biome> context) {
        context.register(SKYLAND, testBiome(context));
    }
